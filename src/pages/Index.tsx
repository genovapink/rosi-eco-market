...
const stats = [
  { label: "Sampah Di-scan", value: "0", icon: Scan },
  { label: "Didaur Ulang", value: "0", icon: Recycle },
  { label: "Pengguna Aktif", value: "0", icon: TrendingUp },
];

const categories = [
  { name: "Plastik", emoji: "♻️", color: "bg-rosi-blue/10 text-rosi-blue" },
  { name: "Kaca", emoji: "🫙", color: "bg-rosi-green/10 text-rosi-green" },
  { name: "Kertas", emoji: "📄", color: "bg-rosi-yellow/10 text-rosi-yellow" },
  { name: "Logam", emoji: "🔩", color: "bg-muted text-muted-foreground" },
  { name: "Organik", emoji: "🍂", color: "bg-rosi-orange/10 text-rosi-orange" },
  { name: "Elektronik", emoji: "💻", color: "bg-rosi-purple/10 text-rosi-purple" },
];
  ...
  return (
    <div className="px-4 pt-6 space-y-6">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-sm opacity-90 mb-4">
            Dapatkan Poin ROSi & bantu kurangi sampah
          </p>
          <button
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          onClick={() => navigate("/scan")}
          className="rosi-gradient text-primary-foreground rounded-xl p-4 text-left"
        >
        ...
        <button
          ...
          className="bg-card border border-border text-foreground rounded-xl p-4 text-left"
        >
